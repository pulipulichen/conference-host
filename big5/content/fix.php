        ...
        <tr class="content">
          ...
          <td colspan="3"><font>
            <select name="Class" size='1' id="Class" >
              ...
              <option value="Artificial Neural Networks" <?php if (!(strcmp("Artificial Neural Networks", $row_fix['Class']))) {echo "SELECTED";} ?>>類神經網路 (Artificial Neural Networks) </option>
...
?>
        ...
        <tr class="content">
          ...
          <td colspan="3"><input name="phone" type="text" id="phone" value="<?php echo $row_fix['Phone']; ?>" size="25"></td>
        </tr>
        <tr class="content">
        ...
        <tr class="color">
          <td colspan="5"><span class="style1">注意!</span>檔案上傳只限<span class="style1">pdf</span>檔，上限為<span class="style1">3MB</span>謝謝合作 有問題請email：<a href="mialto:taai@nuk.edu.tw">taai2005@nuk.edu.tw</a><br>
