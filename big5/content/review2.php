...
<form>
  ...
  <table width="560"  border="1" cellpadding="2" cellspacing="0" bordercolor="#666666">
    <tr>
      <td class="content">角逐最佳論文獎</td>
      <td width="25%" class="content"><label for="item8">
        <input name="item8" type="radio" value="3"<?php if($row_review['item8']==3)echo ' checked'; ?>>
        強烈推薦(3)</label></td>
      <td width="25%" class="content"><label for="item8">
        <input name="item8" type="radio" value="2"<?php if($row_review['item8']==2)echo ' checked'; ?>>
        推薦(2)</label></td>
      <td width="25%" class="content"><label for="item8">
        <input name="item8" type="radio" value="1"<?php if($row_review['item8']==1)echo ' checked'; ?>>
        不推薦(1)</label></td>
    </tr>
  </table>
<?php if($row_review['item9']!='0'){ ?>
  <br>
  <table width="560" border="1" cellpadding="2" cellspacing="0" bordercolor="#666666">
      <tr>
          <td>是否推薦至期刊論文</td>
      <td width="25%" class="content"><label for="item9">
        <input name="item9" type="radio" value="3"<?php if($row_review['item9']==3)echo ' checked'; ?>>
        強烈推薦(3)</label></td>
      <td width="25%" class="content"><label for="item9">
        <input name="item9" type="radio" value="2"<?php if($row_review['item9']==2)echo ' checked'; ?>>
        推薦(2)</label></td>
      <td width="25%" class="content"><label for="item9">
        <input name="item9" type="radio" value="1"<?php if($row_review['item9']==1)echo ' checked'; ?>>
        不推薦(1)</label></td>
      </tr>
  </table>
<?php } ?>
